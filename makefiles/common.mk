...
ifeq ($(THEOS_USE_SEPARATE_LOCAL_DATA_DIR), 1)
	...
	_THEOS_LOCAL_DATA_DIR := $(HOME)/.theos/$(shell basename "$(_THEOS_REAL_PROJECT_DIR)").$(shell echo $(_THEOS_REAL_PROJECT_DIR)|md5|awk '{print $$1}')
endif
...
BACKSLASHED_SIMJECT_ROOT = $(subst /,\/,$(SIMJECT_ROOT))
