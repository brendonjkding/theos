...
THEOS_OBJ_DIR = $(_THEOS_LOCAL_DATA_DIR)/$(THEOS_OBJ_DIR_NAME)/$(THEOS_CURRENT_ARCH)$(_THEOS_CURRENT_TOOLCHAIN)
endif
...
ifdef SIMULATOR
SIMULATOR_ROOT ?= /opt/simject
BACKSLASHED_SIMULATOR_ROOT = $(subst /,\/,$(SIMULATOR_ROOT))
endif
