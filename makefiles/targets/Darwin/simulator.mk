...
ARCHS ?= $(if $(_TARGET_VERSION_GE_8_0),,i386) $(if $(and $(_TARGET_VERSION_GE_7_0),$(if $(THEOS_IS_APPLE_SILICON),,$(_THEOS_TRUE))),x86_64) $(if $(and $(_TARGET_VERSION_GE_14_0),$(THEOS_IS_APPLE_SILICON)),arm64)
...
THEOS_LIBRARY_PATH = $(THEOS)/lib/iphone_simulator
THEOS_VENDOR_LIBRARY_PATH = $(THEOS)/vendor/lib/iphone_simulator
endif
