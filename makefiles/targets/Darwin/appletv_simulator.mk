...
ARCHS ?= $(if $(THEOS_IS_APPLE_SILICON),arm64,x86_64)
NEUTRAL_ARCH := x86_64
...
THEOS_LIBRARY_PATH = $(THEOS)/lib/appletv_simulator
THEOS_VENDOR_LIBRARY_PATH = $(THEOS)/vendor/lib/appletv_simulator
endif
