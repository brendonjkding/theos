...
ifneq ($($(THEOS_CURRENT_INSTANCE)_PRIVATE_FRAMEWORKS),)
...
_THEOS_TARGET_OS_DEPLOYMENT_VERSION = $(or $(TARGET_OS_DEPLOYMENT_VERSION_$(THEOS_CURRENT_ARCH)),$(__THEOS_TARGET_ARG_$(word 2,$(_THEOS_TARGET_ARG_ORDER))),$(TARGET_OS_DEPLOYMENT_VERSION),$(_SDKVERSION),$(_THEOS_TARGET_DEFAULT_OS_DEPLOYMENT_VERSION))
