...
ifeq ($(_THEOS_TARGET_PLATFORM_IS_SIMULATOR),$(_THEOS_TRUE))
	$(ECHO_NOTHING)mv $(THEOS_STAGING_DIR)$(LOCAL_INSTALL_PATH)/$(THEOS_CURRENT_INSTANCE).plist $(THEOS_STAGING_DIR)$(ECHO_END)
	$(ECHO_NOTHING)mv $(THEOS_STAGING_DIR)$(LOCAL_INSTALL_PATH)/$(THEOS_CURRENT_INSTANCE).dylib $(THEOS_STAGING_DIR)$(ECHO_END)
endif
endif
